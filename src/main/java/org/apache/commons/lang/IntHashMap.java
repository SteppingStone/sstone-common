 ...
 * 
 * <p>
 * Note that this class is for internal optimization purposes only, and may not be supported in
 ...
 * Changelog: 
 * 
 * Greg Orlowski (EDC): I removed methods to check if the hash contains a value.
 ...
 * @author Greg Orlowski (greg_orlowski@yahoo.com -- added Enumeration, removed some unused code,
...
public class IntHashMap {
    ...
    /**
     * NOTE: this is not part of commons-lang IntHashMap
     * 
     * @author Greg Orlowski
     */
    static class KeysEnumeration implements Enumeration {
        private Entry next = null;
        private Entry[] table;
        private int idx;

        KeysEnumeration(Entry[] table) {
            KeysEnumeration.this.table = table;
            idx = table.length;
            advanceToNextTableEntry();
        }
        ...
        public Object nextElement() {
            Object ret = new Integer(next.hash);
            if ((next = next.next) == null)
                advanceToNextTableEntry();
            return ret;
        }

        private final void advanceToNextTableEntry() {
            while (--idx >= 0 && ((next = table[idx]) == null))
                ;
        }
    ...
    public Enumeration keys() {
        return new KeysEnumeration(table);
    }
     ...
     * @return the value to which the key is mapped in this hashtable; <code>null</code> if the key
     ...
     * The key cannot be <code>null</code>.
     * </p>
     * 
     * <p>
